...
[Aggregationsfunktionen kennenlernen](../using/building-journeys/functions/aggregation-functions.md)
:::
...
[Konversionsfunktionen erkunden](../using/building-journeys/functions/conversion-functions.md)
:::
...
[Dokumentation zu Datumsfunktionen anzeigen](../using/building-journeys/functions/date-functions.md)
:::
...
[Informationen zu Listenfunktionen](../using/building-journeys/functions/list-functions.md)
:::
...
- **[Mathematische Funktionen](../using/building-journeys/functions/math-functions.md)** – Erkunden Sie mathematische Funktionen wie „random“ und „round“ für numerische Berechnungen in Journey-Ausdrücken.
- **[Zeichenfolgenfunktionen in Adobe Journey Optimizer](../using/building-journeys/functions/string-functions.md)** – Bearbeiten Sie Zeichenfolgen mithilfe von Funktionen für Verkettung, Extraktion von Teilzeichenfolgen, Formatierung und mehr in Journey-Ausdrücken.
