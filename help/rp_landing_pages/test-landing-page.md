...
<img alt="Senden einer Nachricht an Abonnierende" src="../using/assets/do-not-localize/start-quick.png">
</a>
<div>
...
<img alt="Senden von zeitgebundenen Nachrichten" src="../using/assets/do-not-localize/icon-first-journey.svg">
</a>
<div>
