...
+ Neue Funktionen {#whats-new}
   ...
   + {hide-from-toc}[Versionshinweise](using/rn/release-notes-2.md)
   + {hide-from-toc}[Versionshinweise](using/rn/release-notes-3.md)
...
+ Treue-Challenges {#loyalty-challenges}
   ...
   + {hide-from-toc}[Konfigurieren des Treueprogramms](using/loyalty-challenges/loyalty-admin.md)
