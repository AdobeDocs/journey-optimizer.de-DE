...
+ Neue Funktionen {#whats-new}
   ...
   + {hide-from-toc}[Migrieren von Batch-Zielgruppen aus der Zielgruppen-Qualifizierung](using/building-journeys/aq-batch-audiences-migration.md)
+ Erste Schritte {#get-started}
   ...
   + Grundlagen {#essentials}
      ...
      + [Von Ihrem Ziel starten](using/start/ajo-use-case-guide.md)
   ...
   + Effizientes Arbeiten {#work-efficiently}
      ...
      + {hide-from-toc}[Journeys im Vergleich zu Kampagnen](using/start/journeys-vs-campaigns.md)
+ Journeys {#orchestrate-journeys}
   ...
   + {hide-from-toc}[Journey-Typen: Wählen Sie den richtigen aus](using/building-journeys/journey-types-selection.md)
   ...
   + Erstellen einer Journey {#create-journey}
      ...
      + [Versenden in Schüben in Journeys](using/building-journeys/send-using-waves.md)
      ...
      + Simulation {#simulate-journey}
         + [Erste Schritte mit der Journey-Simulation](using/building-journeys/simulate-journey-gs.md)
   ...
   + Aktivitäten {#about-journey-building}
      ...
      + [Journey-Fragmente](using/building-journeys/journey-fragments.md)
   ...
   + Erstellen von Ausdrücken {#building-advanced-conditions-journeys}
      ...
      + Syntax {#syntax}
         ...
         + {hide-from-toc}[Beispiele](using/building-journeys/expression/advanced-editor-use-cases.md)
...
+ Treue-Challenges {#loyalty-challenges}
   + {hide-from-toc}[Erste Schritte mit Treue-Challenges](using/loyalty-challenges/get-started.md)
   + {hide-from-toc}[Zugreifen auf und Verwalten von Challenges und Aufgaben](using/loyalty-challenges/access-loyalty-challenges.md)
   + {hide-from-toc}[Erstellen von Challenges](using/loyalty-challenges/create-challenges.md)
   + {hide-from-toc}[Erstellen von Aufgaben](using/loyalty-challenges/create-tasks.md)
   + {hide-from-toc}[Überwachen der Leistung von Treue-Challenges](using/loyalty-challenges/loyalty-reporting.md)
   + {hide-from-toc}[Konfigurieren von Treue-Challenges](using/loyalty-challenges/loyalty-admin.md)
   + {hide-from-toc}[Treuedaten und -datensätze](using/loyalty-challenges/loyalty-data-and-datasets.md)
   + {hide-from-toc}[API-Referenz für Treue-Challenges](https://developer.adobe.com/journey-optimizer-apis/references/loyalty-challenges)
+ Kampagnen {#campaigns}
   + {hide-from-toc}[Kampagnen](/help/rp_landing_pages/campaigns-landing-page.md)
   ...
   + Orchestrierte Kampagnen {#orchestrated-campaigns}
      ...
      + Aktivitäten für orchestrierte Kampagnen {#design-campaigns}
         ...
         + [Inkrementelle Abfrage](using/orchestrated/activities/incremental-query.md)
         + {hide-from-toc}[Datei laden](using/orchestrated/activities/load-file.md)
      ...
      + Erweiterte Vorgänge {#orchestrated-advanced}
         + [Verwenden von Variablen in orchestrierten Kampagnen](using/orchestrated/variables-orchestrated-campaigns.md)
         + [Definieren globaler Variablen in orchestrierten Kampagnen](using/orchestrated/global-variables.md)
         + [Auslösen von orchestrierten Kampagnen durch ein Signal](using/orchestrated/trigger-orchestrated-campaign.md)
+ Konflikte und Priorisierung {#conflict-prioritization}
   ...
   + Journey-Schlichtung {#journey-arbitration}
      + [Verwenden von Formeln zum Anordnen von Journeys](using/conflict-prioritization/journey-ranking-formulas.md)
      + [Verwenden von KI-Modellen zum Ranking von Journeys](using/conflict-prioritization/journey-ai-models.md)
...
+ Kommunikationskanäle {#channels}
   ...
   + E-Mail-Kanal {#email}
      ...
      + Gestalten von E-Mail-Inhalten {#design-email}
         ...
         + Erste Schritte mit dem Erstellen von Inhalten {#start-creating-content}
            + {hide-from-toc}[Erste Schritte beim Erstellen von Inhalten](/help/rp_landing_pages/start-creating-content-landing-page.md)
         ...
         + Erstellen von Inhalten {#add-content}
            ...
            + [Personalisieren von URLs](using/email/url-personalization.md)
            + [Einfügen von personalisierten Angeboten](using/email/add-offers-email.md)
            + [Optimieren von E-Mails für KI-Posteingänge](using/email/llm-email-optimizer.md)
            + [Verwalten der Textversion](using/email/text-version-email.md)
         ...
         + Bearbeiten des Stils {#edit-style}
            + {hide-from-toc}[Bearbeiten des Stils](/help/rp_landing_pages/edit-style-landing-page.md)
         ...
         + [Inhaltsprüfung](using/email/content-check.md)
   ...
   + Kanal für Push-Benachrichtigungen {#push}
      ...
      + Konfigurieren von Push-Benachrichtigungen {#push-config}
         ...
         + [Konfigurieren des Kanals für Web-Push-Benachrichtigungen](using/push/push-configuration-web.md)
   ...
   + SMS-/MMS-/RCS-Kanal {#mobile}
      ...
      + [Gestalten einer Mobilnachricht](using/mobile/design-mobile.md)
      + [Überprüfen und Senden von Mobilnachrichten](using/mobile/send-mobile-message.md)
      ...
      + Konfigurieren des mobilen Kanals {#configure-mobile}
         ...
         + [Konfigurieren eines benutzerdefinierten Anbieters](using/mobile/mobile-configuration-custom.md)
         + [Erstellen eines Webhook](using/mobile/mobile-webhook.md)
         + [Erstellen einer Mobilkonfiguration](using/mobile/mobile-configuration-surface.md)
         + [Verwenden eines benutzerdefinierten Datensatzes für eingehende Keywords](using/mobile/custom-dataset-inbound-keywords.md)
   ...
   + Posteingang {#inbox}
      ...
      + [Konfigurieren eines Posteingangskanals in Journey Optimizer](using/inbox/inbox-configuration.md)
      + [Erstellen des Posteingangs](using/inbox/inbox-create.md)
      + [Gestalten des Posteingangs](using/inbox/inbox-design.md)
   + WhatsApp {#whatsapp}
...
+ Content-Management {#content-management}
   ...
   + Personalisierung {#personalization}
      ...
      + [Verschlüsseln von URL-Parametern in Tracking-Links](using/personalization/url-parameter-encryption.md)
      + Liste der Hilfsfunktionen {#functions}
         ...
         + {hide-from-toc}[Helper zur Suche externer Daten](using/personalization/external-data-lookup.md)
      ...
      + Anwendungsfälle für die Personalisierung {#personalization-use-cases}
         ...
         + [Personalisierungsrezepte](using/personalization/personalization-recipes.md)
   ...
   + Inhaltsvorlagen {#content-templates}
      ...
      + [Konvertieren von Bildern in E-Mail-Vorlagen](using/content-management/image-to-html.md)
   ...
   + Lösungsübergreifende Anwendungsfälle {#combine}
      ...
      + {hide-from-toc}[Einfügen eines Countdown-Timers](using/integrations/countdown.md)
      + [Arbeiten mit GenStudio for Performance Marketing](using/integrations/genstudio.md)
      + [Integrieren mit Intelligent Services](using/integrations/intelligent-services.md)
      + Integrationen {#integrations}
         ...
         + Beispiele für Anbieter {#vendors}
            + [Erste Schritte mit der Anbieterintegration](using/integrations/vendor-integration-gs.md)
   ...
   + KI-Assistent für die Inhaltsgenerierung {#ai-assistant}
      ...
      + [KI-Assistent für Personalisierungsausdrücke](using/content-management/generative-personalization-expressions.md)
      ...
      + Marken {#brands}
         ...
         + [Auswerten der Inhalte](using/content-management/brands-score.md)
...
+ Berichterstellung {#reporting}
   ...
   + Bericht für die gesamte Zeit {#channel-report}
      ...
      + Kampagnenberichte {#campaign-reporting}
         ...
         + {hide-from-toc}[Live-Aktivitäten-Kampagnenbericht](using/reports/campaign-global-report-cja-activity.md)
...
+ Entscheidungsfunktionen {#decisioning}
   ...
   + Entscheidungsfindung {#experience-decisioning}
      ...
      + Migrieren zur Entscheidungsfindung {#migrate-to-decisioning}
         + [Vorteile der Migration zur Entscheidungsfindung](using/experience-decisioning/migrate-to-decisioning.md)
         + [Entscheidungsfindungsmigrations-API](using/experience-decisioning/decisioning-migration-api.md)
      + API-Referenz {#experience-decisioning-api-reference}
         + {hide-from-toc}[API-Referenz](/help/rp_landing_pages/experience-decisioning-api-reference-landing-page.md)
      ...
      + Erfassen von Ereignisdaten {#experience-decisioning-collect-event-data}
         + {hide-from-toc}[Erste Schritte mit der Datenerfassung](using/experience-decisioning/data-collection/data-collection.md)
         + {hide-from-toc}[Erstellen eines Datensatzes zum Erfassen von Ereignissen](using/experience-decisioning/data-collection/create-dataset.md)
   ...
   + Entscheidungs-Management {#offer-decisioning}
      ...
      + Erstellen und Verwalten von Angeboten {#managing-offers-in-the-offer-library}
         ...
         + Konfigurieren von Angeboten {#configure-offers}
            ...
            + [Unterstützte Funktionen im Personalisierungseditor](using/offers/offer-library/personalization-editor-supported-functions.md)
...
+ Kanalkonfiguration {#configuration}
   ...
   + {hide-from-toc}[AJO-Nachrichtenexportschema](using/configuration/message-export-schema.md)
   ...
   + E-Mail-Subdomains delegieren {#delegate-subdomains}
      ...
      + [Migrieren von CNAME zur benutzerdefinierten Delegierung](using/configuration/custom-subdomain-migration.md)
   ...
   + Implementieren eines IP-Aufwärmplans {#implement-ip-warmup-plan}
      ...
      + {hide-from-toc}[Dateien für den IP-Aufwärmplan](using/configuration/ip-warmup-plan-files.md)
   + E-Mail-Adressen überwachen {#monitor-reputation}
      + [E-Mail-Adressen überwachen](/help/rp_landing_pages/monitor-reputation-landing-page.md)
      + {hide-from-toc}[E-Mail-Fehlertypen](using/configuration/email-error-types.md)
