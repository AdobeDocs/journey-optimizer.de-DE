...
+ Content-Management {#content-management}
   ...
   + Personalisierung {#personalization}
      ...
      + Verwenden von Adobe Experience Platform-Daten für die Personalisierung {#aep-data-perso}
   ...
   + Lösungsübergreifende Anwendungsfälle {#combine}
      ...
      + {hide-from-toc}[Arbeiten mit KI-Assistenten über MCP](/help/using/integrations/ajo-mcp.md)
