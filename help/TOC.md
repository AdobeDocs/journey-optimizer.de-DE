...
+ Erste Schritte {#get-started}
   ...
   + Grundlagen {#essentials}
      ...
      + [Wählen Sie die richtige Funktion für Ihr Ziel aus](using/start/ajo-use-case-guide.md)
...
+ Journeys {#orchestrate-journeys}
   ...
   + {hide-from-toc}[Journey-Typen und Auswahlrichtlinien](using/building-journeys/journey-types-selection.md)
