...
<tr style="border: 0;">
  <td>
   ...
   <p>
    ...
    <p>Machen Sie sich mit den wichtigsten Schritten zur Konfiguration von  vertraut [!DNL Journey Optimizer]</p>
    <p>
    <div>
    ...
    <li>Tipps und Tricks zur Bereitstellung von Kundenerlebnissen, die den Geschäftserfolg fördern</li>
  </td>
   <td>
   <div><strong>Direkte Links zu wichtigen Ressourcen</strong>
    ...
    <li>
      ...
      <li>
      <a href="using/email/fragments.md">Fragmente</a>
    </li>
    <p>
