...
description: Richtlinien zur Überwachung und Zustellbarkeit kennen lernen
...
Die Zustellbarkeit ist ein Maßstab für den Erfolg Ihrer Versände, die Posteingänge Ihrer Empfänger zu erreichen.
...
Generell empfehlen wir, Empfänger nicht darin zu behindern, sich abzumelden, indem Sie von ihnen verlangen, Felder wie beispielsweise ihre E-Mail-Adresse oder ihren Namen auszufüllen. Die Landingpage für die Abmeldung sollte nur einen einzigen Validierungs-Button aufweisen.
...
Zum Schutz Ihrer Zustellbarkeit werden die Empfänger, deren Adressen auf dieser Liste stehen, standardmäßig von allen zukünftigen Versänden ausgeschlossen, da das Senden an diese Kontakte Ihre Reputation beschädigen könnte.

[Erfahren Sie mehr über die Unterdrückungsliste](suppression-list.md).

## Überwachungs-Tools verwenden {#monitoring-tools}

Verwenden Sie die von [!DNL Journey Optimizer] bereitgestellten Funktionen zur Überwachung der Zustellbarkeit.

Auf der Registerkarte **[!UICONTROL Ausführungen]** der Nachrichtenliste können Sie mit einer Reihe von Echtzeitindikatoren überprüfen, wie Ihre Versände funktionieren. Auf dieser Registerkarte wird unter anderem Folgendes angezeigt:
...
[Erfahren Sie mehr über die Überwachung der Nachrichtenausführung](message-monitoring.md).
