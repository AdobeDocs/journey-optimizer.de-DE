...
Sie können Ihre JSON-Payload entsprechend jeder Nachricht nach dem folgenden Muster aufbauen. Anschließend fügen Sie diese Payload bei der Konfiguration der Aktion in Journey Optimizer ein (siehe unten).
