...
**Auf dieser Seite** Verbinden Sie eine REST-API eines Drittanbieters mit Ihren Journeys, indem Sie den Endpunkt, die Authentifizierung, die Sicherheit und die Payload-Parameter einer benutzerdefinierten Aktion einrichten, damit die Journey diesen Service aufrufen können.
...
## Transport-Sicherheitsschicht {#tls}
