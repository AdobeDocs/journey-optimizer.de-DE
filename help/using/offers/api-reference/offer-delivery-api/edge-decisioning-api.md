...
Damit Sie das SDK verwenden können, muss ein [Schema](../../../data/get-started-schemas.md) vorhanden und ein [Datenstrom](../../../start/get-started-datasets.md) definiert worden sein.
