...
>[!NOTE]
>
>Ausgewählten Benutzern wird derzeit vorab Zugriff auf die Verwendung des Entscheidungs-Managements im Adobe Experience Platform Web SDK gewährt. Diese Funktion steht nicht allen Unternehmen zur Verfügung.
...
Damit Sie das SDK verwenden können, muss ein [Schema](../../../start/get-started-schemas.md) vorhanden und ein [Datenstrom](../../../start/get-started-datasets.md) definiert worden sein.
