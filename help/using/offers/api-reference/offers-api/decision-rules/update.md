...
# Aktualisieren einer Entscheidungsregel {#update-decision-rule}
...
Sie können Entscheidungsregeln ändern oder aktualisieren, indem Sie eine PATCH-Anfrage an die [!DNL Offer Library]-API richten.
