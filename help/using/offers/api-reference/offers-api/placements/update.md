...
# Aktualisieren einer Platzierung {#update-placement}
...
Sie können eine Platzierung ändern oder aktualisieren, indem Sie eine PATCH-Anfrage an die [!DNL Offer Library]-API richten.
