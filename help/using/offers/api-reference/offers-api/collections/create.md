...
Bei einer erfolgreichen Antwort werden Informationen zur neu erstellten Kollektion zurückgegeben, einschließlich der eindeutigen `id`. Sie können die Sammlung verwenden `id` in späteren Schritten, um Ihre Sammlung zu aktualisieren oder zu löschen oder sie in einem späteren Tutorial zum Erstellen einer Entscheidung zu verwenden.
