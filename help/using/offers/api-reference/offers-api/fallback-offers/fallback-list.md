...
Ein Fallback-Angebot wird an Kunden gesendet, wenn sie nicht für andere Angebote geeignet sind. Die Schritte zum Erstellen eines Fallback-Angebots bestehen darin, eine oder mehrere Darstellungen zu erstellen, beispielsweise beim Erstellen eines Angebots.

Sie können eine Liste aller Fallback-Angebote in einem Container anzeigen, indem Sie eine GET-Anfrage an die [!DNL Offer Library] API.
...
Eine erfolgreiche Antwort gibt eine Liste von Fallback-Angeboten zurück, die in dem Container vorhanden sind, auf den Sie Zugriff haben.
