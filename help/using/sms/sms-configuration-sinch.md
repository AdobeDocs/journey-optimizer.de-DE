...
1. Konfigurieren Sie Ihre SMS-API-Anmeldedaten, wie unten beschrieben.
   ...
   * **[!UICONTROL Eingehende Nummer]**: Fügen Sie Ihre eindeutige Eingehende-Nummer oder Ihre Kurzwahlnummer hinzu. Auf diese Weise können Sie dieselben API-Anmeldeinformationen für verschiedene Sandboxes verwenden, von denen jede über eine eigene eingehende Nummer oder Kurzwahlnummer verfügt.
