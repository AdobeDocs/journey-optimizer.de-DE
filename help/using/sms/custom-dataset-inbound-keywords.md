...
Konfigurieren Sie die Anmeldedaten entsprechend Ihrem SMS-Provider mit [Erste Schritte mit der SMS-/MMS-/RCS-Konfiguration](sms-configuration.md). Führen Sie dann die folgenden Schritte aus, um den benutzerdefinierten eingehenden Datensatz auszuwählen.
