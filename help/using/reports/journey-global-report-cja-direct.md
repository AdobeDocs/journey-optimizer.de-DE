...
description: Informationen zum Verwenden von Direkt-Mail-Daten aus dem Journey-Bericht
...
# Journey-Bericht zu Direkt-Mail {#journey-global-report}

>[!BEGINSHADEBOX]

Sie können auf Ihren Briefpost-Journey-Bericht zugreifen, indem Sie auf die Schaltfläche **[!UICONTROL Bericht anzeigen]** auf Ihrer Journey klicken. [Weitere Informationen](report-gs-cja.md)
