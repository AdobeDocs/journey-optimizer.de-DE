...
* [Erneuerung der AJO-Domänenzertifikate fehlgeschlagen](#alert-certificates-renewal-unsuccessful) - Warnt, wenn Ressourcen- oder Verfolgungszertifikate in einer benutzerdefinierten Subdomain-Delegierung bald ablaufen oder abgelaufen sind
...
### Verlängerung von AJO-Domänenzertifikaten fehlgeschlagen {#alert-certificates-renewal-unsuccessful}
