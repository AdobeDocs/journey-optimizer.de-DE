...
**Auf dieser Seite** Erfahren Sie, wie Sie eine Reporting-Datenquelle konfigurieren, indem Sie Datensätze hinzufügen, damit Journey Optimizer die zusätzlichen Metriken abrufen kann, die in Ihren Experiment- und Kampagnenberichten verwendet werden.
