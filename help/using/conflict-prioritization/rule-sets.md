...
**Auf dieser Seite** Gruppieren Sie Häufigkeitsbegrenzungen, Ruhezeiten und Journey-Begrenzungsregeln in Regelsätze, damit Sie steuern können, wie oft und wie viele Nachrichten jeder Kunde erhält.
...
Weitere Informationen zu Berechtigungen finden Sie in [diesem Abschnitt](../administration/high-low-permissions.md).
