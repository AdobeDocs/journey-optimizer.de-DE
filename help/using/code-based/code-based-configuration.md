...
**Auf dieser Seite** Erfahren Sie, wie Sie eine Code-basierte Erlebniskanal-Konfiguration erstellen, die die Oberfläche, Plattform und den Ort definiert, an dem Ihre Inhalte in Ihrer Anwendung oder Web-Seite bereitgestellt und genutzt werden.
