...
title: Erstellen mehrstufiger Kampagnen mit Adobe Journey Optimizer
description: Erfahren Sie, wie Sie mehrstufige Kampagnen mit Adobe Journey Optimizer erstellen
hide: true
hidefromtoc: true
...
# Orchestrieren von mehrstufigen Kampagnenaktivitäten {#orchestrate}

Sobald Sie [mehrstufige Kampagne erstellt haben](gs-campaign-creation.md) ob im mehrstufigen Kampagnenmenü oder innerhalb einer Kampagne, können Sie mit der Orchestrierung der verschiedenen Aufgaben beginnen, die sie ausführen soll. Dazu wird eine visuelle Arbeitsfläche bereitgestellt, mit der Sie ein mehrstufiges Kampagnendiagramm erstellen können. Innerhalb dieses Diagramms können Sie verschiedene Aktivitäten hinzufügen und sie in einer sequentiellen Reihenfolge verbinden.

## Hinzufügen von Aktivitäten {#add}

In diesem Schritt der Konfiguration wird das Diagramm mit einem Startsymbol angezeigt, das den Anfang Ihrer mehrstufigen Kampagne darstellt. Um Ihre erste Aktivität hinzuzufügen, klicken Sie auf die Schaltfläche **+**, die mit dem Startsymbol verbunden ist.

Es erscheint eine Liste von Aktivitäten, die dem Diagramm hinzugefügt werden können. Die verfügbaren Aktivitäten hängen von Ihrer Position innerhalb des mehrstufigen Kampagnendiagramms ab. Wenn Sie Ihre erste Aktivität hinzufügen, können Sie Ihre mehrstufige Kampagne starten, indem Sie beispielsweise eine Audience ansprechen, den mehrstufigen Kampagnenpfad aufteilen oder eine **Warten**-Aktivität festlegen, um die Ausführung der mehrstufigen Kampagne zu verzögern. Andererseits können Sie nach einer Aktivität **Zielgruppe aufbauen** Ihre Zielgruppe mit Zielgruppenbestimmungsaktivitäten verfeinern, einen Versand an Ihre Zielgruppe mit Kanalaktivitäten durchführen oder den mehrstufigen Kampagnenprozess mit Flusssteuerungsaktivitäten organisieren.
...
* **Deaktivieren/Aktivieren** der Aktivität. Wenn die mehrstufige Kampagne ausgeführt wird, werden deaktivierte Aktivitäten und die folgenden Aktivitäten auf demselben Pfad nicht ausgeführt und die mehrstufige Kampagne wird gestoppt.
* **Anhalten/Fortsetzen** der Aktivität. Wenn die mehrstufige Kampagne ausgeführt wird, wird sie bei der angehaltenen Aktivität angehalten. Die entsprechende Aufgabe und alle ihr im gleichen Pfad folgenden Aufgaben werden nicht ausgeführt.
...
Sie können mehrstufige Kampagnenaktivitäten kopieren und in einen beliebigen Workflow einfügen. Die mehrstufige Ziel-Kampagne kann sich auf einer anderen Browser-Registerkarte befinden.
...
Mit Journey Optimizer können Sie eine Aktivität zusammen mit dem gesamten Inhalt ihrer untergeordneten Knoten (einschließlich aller darin enthaltenen Transitionen und Aktivitäten) an das Ende einer anderen Transition innerhalb derselben mehrstufigen Kampagne verschieben.
...
Im Feld **Max. Ausführungsdauer** können Sie eine maximale Dauer festlegen, z. B. „30s“ oder „1h“. Wenn die Aktivität nach Ablauf der angegebenen Dauer nicht abgeschlossen ist, wird ein Warnhinweis ausgelöst. Dies hat keine Auswirkungen auf die Funktionsweise der mehrstufigen Kampagne.
...
**Affinität** können Sie die Ausführung einer mehrstufigen Kampagne oder einer mehrstufigen Kampagnenaktivität auf einem bestimmten Computer erzwingen. Dazu müssen Sie eine oder mehrere Affinitäten für die betreffende mehrstufige Kampagne oder Aktivität angeben.
...
Im Folgenden finden Sie ein Beispiel für eine mehrstufige Kampagne, die eine E-Mail an alle Kundinnen und Kunden (außer VIP-Kundinnen und Kunden) sendet, die an Kaffeemaschinen interessiert sind.

![](assets/workflow-example.png){zoomable="yes"}{zoomable="yes"}

Um dies zu bewerkstelligen, wurden die folgenden Aktivitäten hinzugefügt:

* Eine Aktivität **[!UICONTROL Verzweigung]** die die mehrstufige Kampagne in drei Pfade unterteilt (einen für jede Kundengruppe),
...
Nachdem Sie die mehrstufige Kampagne abgeschlossen haben, fügen Sie am Ende **[!UICONTROL Diagramms]** Aktivität „Ende“ hinzu. Diese Aktivität ermöglicht es Ihnen, das Ende eines Workflows visuell zu markieren, und hat keine funktionalen Auswirkungen.

Nachdem Sie das mehrstufige Kampagnendiagramm erfolgreich entworfen haben, können Sie die mehrstufige Kampagne ausführen und den Fortschritt der verschiedenen Aufgaben verfolgen. [Erfahren Sie, wie Sie eine mehrstufige Kampagne starten und ihre Ausführung überwachen](start-monitor-campaigns.md)
