...
1. **Wählen Sie die Datensätze aus**, die Sie an das ausgewählte Ziel exportieren möchten. [Erfahren Sie mehr über Journey Optimizer-Datensätze, die für den Export verfügbar sind](#datasets)
