...
>[!NOTE]
>
>Ab dem 1. November 2024 wird für systemgenerierte Journey Optimizer-Datensätze eine TTL-Schutzmaßnahme (Time-to-Live) erzwungen. Außerdem unterstützt Streaming-Segmentierung zu diesem Zeitpunkt nicht mehr die Verwendung von Sende- und Öffnungs-Ereignissen aus Tracking- und Feedback-Datensätzen. [Weitere Informationen](datasets-ttl.md)
