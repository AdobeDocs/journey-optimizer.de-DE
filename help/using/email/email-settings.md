...
**Auf dieser Seite:** Erfahren Sie, wie Sie die E-Mail-Einstellungen in einer Kanalkonfiguration definieren, einschließlich E-Mail-Typ, Subdomain, IP-Pool, Listen-Abmeldung, Kopfzeilenparameter, BCC, Seed-Liste, weiteren Zustellversuchen, URL-Tracking und Ausführungsadresse.
...
Nähere Informationen zu weiteren Zustellversuchen finden Sie in [diesem Abschnitt](../configuration/retries.md).
