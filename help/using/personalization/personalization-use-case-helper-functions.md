...
title: Personalization-Anwendungsfall&colon; E-Mail zu Warenkorbabbruch
...
* Anzeigen einer produktspezifischen Anmerkung unter Verwendung von `{%#if context.journey.events.\`event_ID\`.productListItems.name = „product_name“ %}`
