...
1. Definieren Sie alle Felder aus diesem Array als Payload-Felder für dieses Ereignis.
   ...
   Erfahren Sie mehr über den Datentyp des Produktlistenelements in [Adobe Experience Platform-Dokumentation](https://experienceleague.adobe.com/docs/experience-platform/xdm/data-types/product-list-item.html?lang=de){target="_blank"}.
