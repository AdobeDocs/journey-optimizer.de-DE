...
**Auf dieser Seite** Erstellen Sie wiederverwendbare Entscheidungsregeln und Zielgruppenbestimmungsregeln, damit Sie steuern können, welche Entscheidungselemente und personalisierten Inhalte welchen Zielgruppen in Ihren Kampagnen und Journey angezeigt werden.
...
* Beim Erstellen von [Targeting zur Inhaltsoptimierung](../building-journeys/path-targeting.md) in Journeys oder Kampagnen.
...
1. Wählen Sie die Regelentität aus, um anzugeben, für welchen Objekttyp die Regel erstellt werden soll.
   ...
   * **[!UICONTROL Targeting]**: Die Regel kann beim Erstellen von [Targeting](#targeting-rules)-Regeln verwendet werden, entweder im Rahmen der [Inhaltsoptimierung](../building-journeys/path-targeting.md) in einer Kampagne oder Journey oder in der Aktivität [Journey optimieren](../building-journeys/path-targeting.md).
