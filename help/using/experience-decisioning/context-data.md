...
**Auf dieser Seite** Definieren und speisen Sie Kontextdaten aus Adobe Experience Platform in Decisioning ein, damit Sie Echtzeitinformationen, die zum Zeitpunkt der Entscheidungsanfrage gesendet werden, in Ihren Entscheidungsregeln und Rangfolgeformeln verwenden können.
...
1. So erstellen Sie einen neuen Adobe Experience Platform-Datenstrom:
   ...
   1. Wählen Sie in der Dropdown-Liste **[!UICONTROL Ereignisschema]** das zuvor erstellte Erlebnisereignisschema aus und klicken Sie auf **[!UICONTROL Speichern]**.
