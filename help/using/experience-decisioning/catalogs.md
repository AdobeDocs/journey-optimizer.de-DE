...
**Auf dieser Seite** Konfigurieren Sie den Elementkatalog und bearbeiten Sie sein Schema, damit Sie Ihre Entscheidungselemente organisieren und die bei der Erstellung verfügbaren standardmäßigen und benutzerdefinierten Attribute definieren können.
