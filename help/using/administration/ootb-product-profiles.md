...
| Data Governance | <ul> <li>**[!DNL Manage data usage policies]**: Lesen, Erstellen, Bearbeiten und Löschen von Datennutzungsrichtlinien.</li> <li>**[!DNL Manage usage label]**: Nutzungs-Labels lesen, erstellen und löschen.</li> <li>**[!DNL View data usage policies]**: schreibgeschützter Zugriff auf Datennutzungsrichtlinien.</li> <li>**[!DNL View user activity log]**: Auditprotokolle lesen und exportieren.</li> </ul> |
