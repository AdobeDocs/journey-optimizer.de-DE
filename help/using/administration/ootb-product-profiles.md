...
|Nachrichten| <ul><li>**[!DNL Manage messages]**: Nachrichten und Landingpages lesen, erstellen, bearbeiten und löschen.</li><li>**[!DNL Publish messages]** Nachrichten und Landingpages veröffentlichen.</li><li>**[!DNL Manage messages preview and test]**: Lesen, Erstellen und Bearbeiten der Vorschau von Nachrichten/Landingpages und Senden von Tests/Testsendungen.</li><li>**[!DNL View messages report]**: Nachrichten- und Landingpage-Berichte lesen und bearbeiten.</li></ul>|
...
|Nachrichten| <ul><li>**[!DNL Manage messages]**: Nachrichten und Landingpages lesen, erstellen, bearbeiten und löschen.</li><li> **[!DNL Manage messages preview and test]**: Vorschau von Nachrichten/Landingpages lesen, erstellen und bearbeiten und Test/Testversand durchführen.</li><li>**[!DNL View messages report]**: Nachrichten- und Landingpage-Berichte lesen und bearbeiten.</li></ul>|
|Entscheidungs-Management| <ul><li>**[!DNL Manage decisions]**: Lesen, Erstellen, Bearbeiten und Löschen von Entscheidungsentitäten.</li><li>**[!DNL Manage ranking strategies]**: Lesen, Erstellen, Bearbeiten und Löschen von benutzerdefinierten Nachrichtenberichten und Verwenden von Aktionsfunktionen.</li></ul>| |Adobe Experience Platform| <ul><li> **[!DNL Manage segments]**: Segmente und Abonnementlisten lesen, erstellen, bearbeiten und löschen.</li><li>**[!DNL Manage profiles]**: Lesen, Erstellen, Bearbeiten und Löschen von Profilen.</li><li>**[!DNL Read datasets]**: Nur-Lese-Zugriff auf Datensätze.</li><li>**[!DNL Read schemas]**: Nur-Lese-Zugriff auf Schemas.</li><li>**[!DNL Manage merge policies]**: Lesen, Erstellen, Bearbeiten und Löschen von Zusammenführungsrichtlinien.</li></ul>| |Administration| <ul><li>**[!DNL View messages presets]**: Nur-Lese-Zugriff auf Nachrichtenvoreinstellungen.</li></ul>|
...
|Nachrichten| <ul><li>**[!DNL View messages]**: Schreibgeschützter Zugriff auf Nachrichten und Landingpages.</li><li>**[!DNL View messages report]**: Lesezugriff auf Nachrichten- und Landingpage-Berichte.</li></ul>|
...
|Nachrichten| <ul><li>**[!DNL Manage messages]**: Nachrichten und Landingpages lesen, erstellen, bearbeiten und löschen.</li><li>**[!DNL Manage messages preview and test]**: Lesen, Erstellen und Bearbeiten der Vorschau von Nachrichten/Landingpages und Senden von Tests/Testsendungen.</li><li> **[!DNL View messages report]**: Nachrichten- und Landingpage-Berichte lesen und bearbeiten.</li></ul>|
