...
* Mit Journey Optimizer können Sie die von den Benutzenden im System durchgeführten Aktionen für verschiedene Services und Funktionen wie Kampagnen, Journeys, Nachrichten, Landingpages usw. ermitteln. Administratorprotokollressourcen beinhalten jetzt Änderungen verschiedener anderer Aktionen, die automatisch aufgezeichnet werden, während die Aktivität ausgeführt wird. Weitere Informationen finden Sie auf [dieser Seite](../privacy/audit-logs.md).
...
* Um die Performance zu verbessern, können Feldergruppen für Erlebnisereignisse nicht mehr in Journeys verwendet werden, die mit einer Aktivität vom Typ „Zielgruppe lesen“, „Zielgruppen-Qualifizierung“ oder „Geschäftsereignis“ beginnen. Diese Änderung gilt nur für neue Journeys. Bestehende behalten das aktuelle Verhalten bei. [Weitere Informationen](../start/guardrails.md#expression-editor)
...
<p>In dieser <a href="../mobile/create-mobile-message.md">detaillierten Dokumentation</a> erfahren Sie, wie Sie eine SMS erstellen und senden.</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
<p>Das Plug-in für die Integration von E-Mail-Designer mit Adobe Stock und Adobe Journey Optimizer bietet Kundinnen und Kunden eine einfache Möglichkeit, Bilder zu finden, zu lizenzieren und zu speichern, um sie in der Nachrichtenerstellung zu verwenden. </br> Die neue Option <b>Ähnliche Stock-Fotos suchen</b> ermöglicht es Ihnen auch, Stock-Fotos zu finden, die mit Inhalt, Farbe und Komposition Ihrer Bilder übereinstimmen. </p>
...
<p>Weitere Informationen finden Sie in der <a href="../configuration/copy-objects-to-sandbox.md">ausführlichen Dokumentation</a>.
</td>
</tr>
</tbody>
</table>
...
* **Ausdruckseditor**: Die Funktion [Limit](../building-journeys/functions/list-functions.md#limit) wurde hinzugefügt, um die Anzahl der Elemente einer Liste zu begrenzen. Mit der Funktion [Sortierung](../building-journeys/functions/list-functions.md#sort) können Sie jetzt ein Listenobjekt sortieren. Die Unterstützung von listObject wurde auch den Funktionen [distinct](../building-journeys/functions/list-functions.md#distinct) und [distinctWithNull](../building-journeys/functions/list-functions.md#distinctWithNull) hinzugefügt.
...
* Neue Schrittereignisse im Zusammenhang mit Exportaufträgen werden jetzt von Journey Optimizer an Adobe Experience Platform gesendet. Beispiele für Abfragen wurden der Dokumentation hinzugefügt. [Weitere Informationen](../reports/query-examples.md)
