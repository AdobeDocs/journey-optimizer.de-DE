...
* Die Seite Erste Schritte mit dem Entwerfen von E-Mails wurde aktualisiert, um klarzustellen, wie auf die E-Mail-Designer zugegriffen werden kann. [Weitere Informationen](../email/get-started-email-design.md)

* Der Seite &quot;DMARC-Einträge“ wurde ein Abschnitt zur Fehlerbehebung hinzugefügt, um die DNS-Ausbreitungslatenz zu beheben. [Weitere Informationen](../configuration/dmarc-record.md#troubleshooting)
...
* Auf der Seite Schutzmechanismen und Einschränkungen wurde ein Schutzmechanismus zum Targeting pseudonymer Profile mit eingehenden Kanälen hinzugefügt: Wenn Sie nicht authentifizierte Besucher ansprechen, erhöht sich die Gesamtzahl der kontaktierbaren Profile. Daher empfiehlt Adobe die Festlegung einer Time-to-Live (TTL) für das automatische Löschen von Profilen, um die damit verbundenen Kosten zu verwalten. [Weitere Informationen](../start/guardrails.md#profile-management-inbound)

* Auf der Seite Codebasierte Implementierungsmethoden finden Sie jetzt Verweise auf zwei Tutorials zum Konfigurieren von Web SDK für Decisioning- und Codebasierte Erlebnisse. [Weitere Informationen](../code-based/code-based-decisioning-implementations.md#tutorials)
