...
* Die in Journey Optimizer verfügbaren Adobe-Integrationen werden jetzt im Abschnitt Verbinden Ihrer Systeme und Umgebungen aufgeführt. [Weitere Informationen](../integrations/ajo-integrations.md)

* Die Inhaltsintegrationen werden jetzt im Abschnitt Content-Management gruppiert. [Weitere Informationen](../integrations/content-integrations.md)
...
* Ein neuer Schritt, der beschreibt, wie Code bei Verwendung von Entscheidungsrichtlinien im Code-basierten Erlebnis-Editor eingeschlossen wird, wurde zur Seite Entscheidungsrichtlinien erstellen hinzugefügt. [Weitere Informationen](../experience-decisioning/create-decision.md#use-decision-policy)

* Es wurde ein Hinweis zur Dokumentation zu Code-basierten Erlebnissen hinzugefügt, in dem angegeben wird, dass bei der Ausführung mehrerer Code-basierter Erlebnisaktionen auf derselben Oberfläche der Kampagnen- oder Journey-Prioritätswert bestimmt, was an den Endbenutzer gesendet wird, wenn er für mehr als eine Aktion qualifiziert ist. [Weitere Informationen](../code-based/code-based-surface.md#surface-definition)

* Eine neue Seite zur Fehlerbehebung bei eingehenden Aktionen in Journey enthält eine schrittweise Anleitung, um Probleme unabhängig zu identifizieren und zu beheben, bevor Sie sich an den Support wenden. [Weitere Informationen](../building-journeys/troubleshooting-inbound.md)

* Es wurde eine neue [Seite](../code-based/code-based-decisioning-implementations.md) hinzugefügt, auf der beschrieben wird, wie Sie Ihrer Client-Implementierung die folgenden Flags hinzufügen, wenn Sie Entscheidungsfindungen in Code-basierten Erlebnissen verwenden:

   * Hinzufügen des `dryRun`-Flags zum Testen der Entscheidungsfindung in Code-basierten Erlebnissen. [Weitere Informationen](../code-based/code-based-decisioning-implementations.md#code-based-test-decisions)
