...
* Es wurde ein neuer Abschnitt zu Leitplanken hinzugefügt, um die Validierung der Journey-Payload-Größe zu dokumentieren, einschließlich Warn- und Fehlerschwellen und Anleitungen zur Optimierung von Journey. [Weitere Informationen](../start/guardrails.md#journey-payload-size)

* Die Dokumentation zu Entscheidungs-Leitplanken wurde aktualisiert und enthält jetzt Größenbeschränkungen für Entscheidungselemente (1 KB für Elemente einschließlich Attributen mit maximal 30 Attributen). [Weitere Informationen](../experience-decisioning/decisioning-guardrails.md)

* Es wurde ein Hinweis zur Dokumentation zur Erstellung von Entscheidungsrichtlinien hinzugefügt, um Benutzende darüber zu informieren, dass es nach der Erstellung einer Entscheidungsrichtlinie bis zu 15 Minuten dauern kann, bis Änderungen in allen Datenregionen propagiert werden, und bis zu 30 Minuten für Kanada. [Weitere Informationen](../experience-decisioning/create-decision-policy.md#review)

* Es wurde ein Hinweis zur Fragmentdokumentation hinzugefügt, der darauf hinweist, dass der Tracking-Datensatz den URL-Wert anstelle des Beschriftungswerts protokolliert, wenn sowohl die Schaltflächenbeschriftung als auch die URL in einem Fragment bearbeitbar gemacht werden. [Weitere Informationen](../content-management/customizable-fragments.md#visual)

* Es ist jetzt eine neue Seite verfügbar, die die Vorteile der Migration vom Entscheidungs-Management zum Decisioning beschreibt, einschließlich Informationen über bevorstehende Migrations-Tool-APIs. [Weitere Informationen](../experience-decisioning/migrate-to-decisioning.md)

* Es wurde ein Schutzmechanismus hinzugefügt, der klarstellt, dass Lookup-Datensätze für die eingehende Edge-basierte Aktivierung nur in der Region verfügbar sind, in der sich die Sandbox des Datensatzes befindet. [Weitere Informationen](../data/lookup-aep-data.md#guidelines)

* Es wurde ein neuer Abschnitt zur Dokumentation zur Konfiguration des Kanals für orchestrierte Kampagnen hinzugefügt, in dem erläutert wird, wie kontextuelle Attribute (wie Kampagnen-ID, Name und Aktionsdetails) in URL-Tracking-Parametern für Analyse- und Berichtszwecke verwendet werden. [Weitere Informationen](../orchestrated/channel-config.md#url-tracking)
