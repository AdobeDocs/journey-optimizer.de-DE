...
* Eine neue Seite ist jetzt für das Entscheidungs-Management verfügbar. Es werden alle Operatoren, Helper und Funktionen aufgelistet, die beim Erstellen von Ausdrücken in Angebotsinhalten, Entscheidungsregeln und Rangfolgenformeln unterstützt werden. Verwenden Sie diese Liste, um Laufzeitfehler zu vermeiden. Nur die dokumentierten Funktionen werden vom Entscheidungs-Management unterstützt. [Weitere Informationen](../offers/personalization-editor-supported-functions.md)
