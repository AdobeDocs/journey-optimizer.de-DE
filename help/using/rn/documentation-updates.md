...
* Es wurde ein Hinweis zum Abschnitt Fragmente hinzugefügt, in dem angegeben wird, dass bei aktiviertem Tracking in einer Journey oder Kampagne, wenn Links in einem Fragment vorhanden sind und dieses Fragment in einer E-Mail verwendet wird, diese Links verfolgt werden, wie alle anderen in der Nachricht enthaltenen Links. [Weitere Informationen](../content-management/create-fragments.md#content)
