...
* Der Entscheidungs -Teil wurde mit einem speziellen Abschnitt zum Erstellen von KI-Modellen aktualisiert. [Weitere Informationen](../experience-decisioning/ranking/ai-models.md)

* Es wurde eine Empfehlung zur Verwendung des Felds `actionExecutionTime` in der Aktion „journeyStep-Ereignisse“ hinzugefügt. [Weitere Informationen](../reports/sharing-execution-fields.md#actionexecutiontime-actionexecutiontime-field)

* Es wurde ein Hinweis zur `messageID` hinzugefügt, der möglicherweise nicht für jeden einzelnen Versand eindeutig ist. [Weitere Informationen](../data/datasets-query-examples.md)
...
* Es wurde ein Warnhinweis zu verschachtelten JSON-Objekten hinzugefügt, die in der benutzerdefinierten Authentifizierung für benutzerdefinierte Aktionen nicht unterstützt werden. [Weitere Informationen](../datasource/external-data-sources.md)
...
* Klarstellung der Regeln für den erneuten Eintritt von Journey bei Verwendung zusätzlicher Kennungen. [Weitere Informationen](../building-journeys/supplemental-identifier.md#guardrails--limitations)

* Es wurde ein neuer Hinweis hinzugefügt, um klarzustellen, dass Sie den Ausdruckseditor im erweiterten Modus verwenden müssen, wenn Sie das Attribut Zusätzliche Kennung während der Ereigniskonfiguration auswählen. [Weitere Informationen](../building-journeys/supplemental-identifier.md#add)
...
* Adobe-Integrationen, die mit Journey Optimizer verfügbar sind, werden jetzt im Abschnitt „Verbinden Ihrer Systeme und Umgebungen“ aufgeführt. [Weitere Informationen](../integrations/ajo-integrations.md)
