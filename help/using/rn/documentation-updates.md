...
* Die Benutzeroberfläche von Campaign verfügt jetzt über zwei separate Registerkarten: **Aktion** und **API-ausgelöst**. Die Dokumentation wurde entsprechend aktualisiert, wobei die Informationen zu den einzelnen Kampagnentypen in eigenen Abschnitten organisiert wurden, um die Klarheit und Benutzerfreundlichkeit zu verbessern. [Weitere Informationen](../campaigns/get-started-with-campaigns.md)

* Die Seiten [Erste Schritte mit der Delegierung ](../configuration/about-subdomain-delegation.md) Subdomains[ und Delegieren einer Subdomain](../configuration/delegate-subdomain.md) wurden aktualisiert, um die verschiedenen Delegierungsmethoden und die Schritte zu ihrer Einrichtung besser darzustellen.

* Es wurde ein Hinweis zum Abschnitt Fragmente hinzugefügt, der angibt, dass bei aktiviertem Tracking in einer Journey oder Kampagne diese Links verfolgt werden, wie alle anderen in der Nachricht enthaltenen Links, wenn Links in einem Fragment vorhanden sind und dieses Fragment in einer Nachricht verwendet wird. [Weitere Informationen](../content-management/create-fragments.md#content)

* Die Leitplanken und Einschränkungen, die für die Subdomain-Zuweisung in Journey Optimizer gelten, wurden erweitert und in einem speziellen Abschnitt zusammengefasst. [Weitere Informationen](../configuration/delegate-subdomain.md#guardrails)

* Es wurde ein Hinweis zu den Seiten Fallback-Angebote erstellen und Entscheidung erstellen hinzugefügt, um darauf hinzuweisen, dass Fallback-Angebote alle in einer Entscheidung verwendeten Darstellungen enthalten sollten. [Weitere Informationen](../offers/offer-library/creating-fallback-offers.md)

* Die Leitplanken für Fragmente wurden angereichert. [Weitere Informationen](../start/guardrails.md#fragments-guardrails).

* Es wurde ein Hinweis hinzugefügt, dass Links, die zu Nachrichten hinzugefügt wurden, nach 25 Monaten ablaufen und Links zu Mirrorseiten nach 90 Tagen. [Weitere Informationen](../email/message-tracking.md)
