...
* Auf den Seiten Erste Schritte mit Profilen und Schutzmechanismen wurde ein Hinweis hinzugefügt, der angibt, dass bei der Datenaufnahme bei E-Mails die Groß-/Kleinschreibung beachtet wird. Das bedeutet, dass doppelte Profile erstellt und verwendet werden können, wenn auf den entsprechenden Empfänger gezielt zugegriffen wird. [Weitere Informationen](../audience/get-started-profiles.md)
...
* Die Dokumentation für die Experimentation Accelerator wurde in eine andere Sammlung verschoben. [Weitere Informationen](https://experienceleague.adobe.com/en/docs/experimentation-accelerator/using/overview)
