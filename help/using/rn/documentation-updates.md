...
* Die Delegierung von Subdomains kann derzeit nicht über die Benutzeroberfläche von [!UICONTROL Journey Optimizer] aufgehoben werden. Sie müssen sich hierzu an den Adobe-Support wenden. Die Abschnitte zu den Subdomains E-Mail, Landingpage, SMS und Web wurden mit diesen Informationen und den Schritten aktualisiert, die durchgeführt werden sollten, bevor Sie sich an Adobe wenden. [Weitere Informationen](../configuration/delegate-subdomain.md#undelegate-subdomain)
