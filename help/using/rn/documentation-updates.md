...
* Die Dokumentation mit den Code-basierten Implementierungsbeispielen wurde aktualisiert und enthält jetzt das Token-Feld in propositionAction , um ein genaues Tracking und die Attribution in Decisioning zu ermöglichen. [Weitere Informationen](../code-based/code-based-implementation-samples.md)
