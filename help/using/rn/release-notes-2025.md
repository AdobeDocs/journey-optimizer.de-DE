...
## Versionshinweise für Oktober 2025 {#25-10-rn}
...
### Verbesserungen {#oct-25-10-improvements}
...
<p>Weitere Informationen finden Sie in der <a href="https://experienceleague.adobe.com/de/docs/experience-cloud-ai/experience-cloud-ai/agents/ajo-agent#journey-create-agent-skill-overview-and-user-guide" target="_blank">ausführlichen Dokumentation</a>.</p>
...
* **Kampagnen**
   ...
   * **Mehrere eingehende Aktionen in Kampagnen** – Damit die Kampagnenorchestrierung vereinfacht wird, können Sie jetzt mehrere eingehende Aktionen in einer einzigen Kampagne definieren. Mit dieser Funktion können Sie mehrere Code-basierte Erlebnisse, In-App-Nachrichten, Inhaltskarten oder Web-Aktionen gleichzeitig an verschiedenen Orten bereitstellen, wobei jede Aktion einen bestimmten Inhalt enthält.
...
<tr>
<td>
<p>Dynamic Media-Assets sind jetzt direkt in Journey Optimizer verfügbar und zugänglich. Diese Integration ermöglicht Folgendes:
<ul>
...
Sie können jetzt benutzerdefinierte Einverständnisrichtlinien über Marketing-Aktionen in Transaktions-E-Mail-Kanalkonfigurationen nutzen. [Weitere Informationen](../action/consent.md#surface-marketing-actions)
...
<p>Weitere Informationen finden Sie in der <a href="../content-management/generative-full-content.md">ausführlichen Dokumentation</a>.</p>
</td>
</tr>
</tbody>
</table>
