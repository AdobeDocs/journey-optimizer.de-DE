...
**Auf dieser Seite** Erfahren Sie, wie Sie eine Zielgruppendimension für orchestrierte Kampagnen konfigurieren, indem Sie dem Kundenprofil ein relationales Schema zuordnen, damit Sie Nachrichten auf Entitätsebene versenden können.
...
1. Wählen Sie den **[!UICONTROL Identitätswert]** für die Entität aus, die Sie ansprechen möchten.
   ...
   [Weitere Informationen finden Sie in der Dokumentation zu Adobe Experience Platform](https://experienceleague.adobe.com/de/docs/experience-platform/xdm/schema/composition#identity)
