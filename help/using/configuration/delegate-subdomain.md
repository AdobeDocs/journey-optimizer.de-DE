...
**Auf dieser Seite** Erfahren Sie, wie Sie Ihre Subdomains für den E-Mail-Versand mithilfe der vollständigen Delegierung oder CNAME-Einrichtung an Adobe in Adobe Journey Optimizer delegieren und wie Sie auf sie zugreifen, sie validieren und die Delegierung aufheben können.
...
* Delegieren einer benutzerdefinierten Subdomain - [Weitere Informationen](delegate-custom-subdomain.md)
...
1. Heben Sie die Delegierung von Landingpage-, SMS- und Web-Subdomains auf, die mit dieser Subdomain verknüpft sind.
   ...
   Sie müssen für jede [Landingpage](../landing-pages/lp-subdomains.md#undelegate-subdomain), [SMS](../mobile/mobile-subdomains.md#undelegate-subdomain)- oder [Web](../web/web-delegated-subdomains.md#undelegate-subdomain)-Subdomain eine dedizierte Anfrage stellen.
