...
**Auf dieser Seite** Erfahren Sie, wie Sie den Web-In-App-Kanal in der Adobe Experience Platform-Datenerfassung konfigurieren, indem Sie die Web-SDK, Trigger-Regeln und eine In-App-Web-Konfiguration einrichten.
