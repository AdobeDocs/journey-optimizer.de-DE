...
>[!TIP]
>
>Sind Ihnen die Eintritts- und Ausstiegskriterien für Journeys neu? Beginnen Sie mit unserem [umfassenden Leitfaden zu Eintritts- und Ausstiegskriterien für Journeys](entry-exit-criteria-guide.md), in dem praktische Anwendungsfälle, Best Practices und schrittweise Anleitungen zur Konfiguration behandelt werden.
...
<img alt="Senden von E-Mails nur an Wochentagen" src="../assets/do-not-localize/icon-first-journey.svg">
</a>
<div>
...
Sehen Sie sich Video-Tutorials an, um die wichtigsten Schritte zum Erstellen der häufigsten Anwendungsfälle mit [!DNL Adobe Journey Optimizer] zu erfahren.
...
      <strong>Abgebrochener Warenkorb</strong><br/><p>Erfahren Sie, wie Sie den Anwendungsfall „Transaktionsabbruch“ mithilfe der Playbook-Funktion in [!DNL Adobe Journey Optimizer] implementieren.</p><a href="https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/tutorials/use-cases/abandoned-cart" target="_blank">Video zu Anwendungsfällen ansehen</a>
  ...
  <tr style="border: 0;">
    ...
    <br/>
      <strong>Angebote mit Rangfolgeformeln personalisieren</strong><br/><p>Erfahren Sie, wie Sie personalisierte Finanzangebote bereitstellen können, indem Sie Benutzerattribute wie Postleitzahl und Jahreseinkommen in [!DNL Adobe Journey Optimizer] nutzen. Durch die Verwendung von Rangfolgeformeln werden Angebote auf intelligente Weise bewertet und basierend auf standortspezifischen Angeboten und einkommensbasierter Eignung priorisiert.</p><a href="https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/personalizing-offers-with-ranking-formulas-based-on-user-zip-code-and-income/introduction" target="_blank">Schrittweises Tutorial befolgen</a> 
    </td>
  </tr>
</table>

Siehe auch das Video-Tutorial [Skalieren der Orchestrierung auf Omnichannel-Interaktionen in  [!DNL Adobe Journey Optimizer]](https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/scaling-orchestration-to-omnichannel-engagement/introduction){target="_blank"}: In sechs Lektionen erfahren Sie, wie Sie die Geschäftskommunikation von einfachen ausgehenden Nachrichten auf anspruchsvolle Omnichannel-Erlebnisse ausweiten können. Anhand von Praxisbeispielen erhalten Sie Erkenntnisse zur Erstellung von Customer Journeys, die proaktive Kontaktaufnahme und responsive Interaktion nahtlos verbinden.
...
<div>
<p><a href="weekday-email-uc.md">Anwendungsfall: Senden von E-Mails nur an Werktagen in [!DNL Adobe Journey Optimizer]</a> - auch als <a href="https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-blogs/how-to-send-emails-only-on-weekdays-in-adobe-journey-optimizer/ba-p/760400?profile.language=de" target="_blank">Community-Blogpost</a></p>
...
<div>
<a href="https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-blogs/mastering-step-events-in-adobe-journey-optimizer-fundamentals/ba-p/762024?profile.language=de" target="_blank">Meistern von Schrittereignissen in [!DNL Adobe Journey Optimizer]: Grundlagen, Schemata und wichtige Abfragen für datengesteuerte Kampagnen
</a></p>
...
<p><a href="https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-blogs/take-flight-with-personalization-how-airlines-can-elevate-offers/ba-p/767513?profile.language=de" target="_blank">Flug mit Personalization: Wie Fluggesellschaften Angebote erhöhen können mit [!DNL Adobe Journey Optimizer]
</a></p>
<p><a href="https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-blogs/mastering-real-time-personalization-a-marketer-s-guide-to-aem/ba-p/762606?profile.language=de" target="_blank">Meistern von Real-Time Personalization: Ein Handbuch für Marketing-Experten zu AEM-Inhaltsfragmenten und -Videos [!DNL Adobe Journey Optimizer]
</a></p>
</div>
<p></td>
<td>
<img alt="Benutzerdefinierte Aktionen" src="../assets/do-not-localize/step-event.jpeg">
<div><p><a href="https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-blogs/how-to-extend-adobe-journey-optimizer-with-custom-actions/ba-p/761323?profile.language=de" target="_blank">Erweitern von [!DNL Adobe Journey Optimizer] mit benutzerdefinierten Aktionen: Anwendungsfälle für die Integration
</a></p>
</div>
<div><p><a href="https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-blogs/breaking-down-barriers-how-adobe-journey-optimizer-s-custom/ba-p/759223?profile.language=de" target="_blank">[!DNL Adobe Journey Optimizer]Die benutzerdefinierte Delegierungsfunktion von löst Probleme mit der Einhaltung von Unternehmensrichtlinien
</a></p>
</div>
