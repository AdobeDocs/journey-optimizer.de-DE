...
Beachten Sie, dass Sie eine Reaktionsaktivität auf der Arbeitsfläche nur verwenden können, wenn zuvor eine Aktivität vom Typ Kanalaktion aufgetreten ist (E-Mail, Push, SMS).
