...
**Auf dieser Seite:** Erfahren Sie mehr über die wichtigsten Schritte zur Erstellung Ihrer ersten Journey in Adobe Journey Optimizer, von der Definition der Einstiegszielgruppe oder des Eintrittsereignisses bis zum Hinzufügen von Aktionen und der Live-Veröffentlichung.
...
**Nicht sicher, welcher Einstiegspunkt verwendet werden soll?** In der folgenden Tabelle werden die häufigsten Anwendungsfälle der richtigen Startaktivität zugeordnet. Weitere Informationen finden Sie in der [Auswahlmatrix für Journey-Typen](journey-types-selection.md).
