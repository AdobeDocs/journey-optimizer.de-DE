...
## Verworfene Ereignisse mit maxInstanceStackEventsReached {#max-instance-stack-events-reached}

Dieser Verwerfungsgrund bedeutet, dass die Journey-Laufzeitumgebung ihr internes Ereignisstapellimit von 10 Ereignissen pro Profil für eine bestimmte Journey-Version erreicht hat. Dies ist ein Schutzmechanismus, der verhindert, dass zu viele ausstehende Ereignisse gestapelt werden, während ein anderes Ereignis für dasselbe Profil noch verarbeitet wird.
