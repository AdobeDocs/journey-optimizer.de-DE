...
role: Admin
level: Intermediate
keywords: Ereignis, einmalig, erstellen, Journey
...
Um in der Echtzeit-Kundenprofildatenbank von Adobe gespeicherte Daten zu verwenden, muss der Ereignisschlüssel die Informationen sein, die Sie in der als Profilidentität definierten [Echtzeit-Kundenprofildienst](https://experienceleague.adobe.com/docs/experience-platform/profile/home.html?lang=de){target="_blank"}.
