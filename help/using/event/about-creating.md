...
1. Klicken Sie auf **[!UICONTROL Hinzufügen]**, um ein neues Ereignis zu erstellen. Der Bereich für die Konfiguration des Ereignisses wird auf der rechten Seite des Bildschirms geöffnet.
...
1. Definieren Sie die Schema- und Payload-Felder: Hier wählen Sie die Ereignis-Informationen aus (meist Nutzlast genannt), die Journey erwarten. Anschließend können Sie diese Informationen in Ihrer Journey verwenden. Siehe [diesen Abschnitt](../event/about-creating.md#define-the-payload-fields).
...
Sie können entweder einen der vordefinierten verwenden oder mit dem Identity Namespace-Dienst einen neuen erstellen. Siehe [Seite](https://experienceleague.adobe.com/docs/experience-platform/identity/home.html).
...
Dadurch kann das System die Abstimmung zwischen dem Ereignis und dem Profil des Kontakts durchführen. Wenn Sie ein Schema mit einer primären Identität auswählen, werden die Felder **[!UICONTROL Schlüssel]** und **[!UICONTROL Namensraum]** vorausgefüllt. Wenn keine Identität definiert ist, wählen Sie _identityMap > id_ als Primärschlüssel aus. Dann müssen Sie einen Namensraum auswählen und der Schlüssel wird vorausgefüllt (unter dem Feld **[!UICONTROL Namensraum]**) mit _identityMap > id_.
...
Sie können den einfachen Ausdruckseditor oder den erweiterten Ausdruckseditor verwenden, um Bedingungen für Ereignisse einzurichten. Siehe [diese Seite](https://experienceleague.adobe.com/docs/journeys/using/building-advanced-conditions-journeys/expressionadvanced.html).
