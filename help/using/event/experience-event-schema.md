...
# Informationen zu ExperienceEvent-Schemas für [!DNL Journey Optimizer] {#about-experienceevent-schemas}

>[!BEGINSHADEBOX]

**Auf dieser Seite** Erstellen Sie XDM-Erlebnisereignis-Schemata, die die erforderliche Struktur aufweisen, damit Ihre Streaming-Ereignisse in Adobe Experience Platform aufgenommen und zum Trigger von Journey verwendet werden können.
