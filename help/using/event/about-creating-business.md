...
**Auf dieser Seite** Konfigurieren Sie ein Geschäftsereignis, damit Sie bei einem globalen Ereignis, z. B. wenn ein Produkt wieder auf Lager ist, eine Journey für eine Reihe von Profilen als Trigger verwenden können.
...
* Nach einem Geschäftsereignis kann nur eine Aktivität vom Typ „Zielgruppe lesen“ eingefügt werden. Sie wird automatisch als nächster Schritt hinzugefügt.
...
* Nachdem ein Geschäftsereignis ausgelöst wurde, gibt es eine Verzögerung von 15 Minuten bis zu einer Stunde, um die Zielgruppe zu exportieren.
