...
>[!NOTE]
>
>Die Simulations-API ist für API-ausgelöste und (geplante) Aktionskampagnen verfügbar. Er wird **nicht für orchestrierte Kampagnen unterstützt**: Verwenden Sie stattdessen den Vorschau- und Korrekturabzugs-Workflow in der Benutzeroberfläche „orchestrierte Kampagnen“ für diese Kampagnen.

| Validieren von Datensätzen und Trigger Orchestrierte Kampagnenausführung | [Datensatzvalidierung](https://developer.adobe.com/journey-optimizer-apis/references/orchestrated-campaign-dataset){target="_blank"} ・ [Trigger &#x200B;](https://developer.adobe.com/journey-optimizer-apis/references/oc-trigger){target="_blank"} ・ [Datensätze aktivieren](../../orchestrated/manual-schema.md) |
