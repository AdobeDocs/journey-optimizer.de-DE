...
Als **Marketer** oder **Journey Practicionner**, sind Sie für die Erstellung von Angeboten und Journey und die Erstellung von Inhalten verantwortlich. Sie können die Arbeit mit [!DNL Adobe Journey Optimizer] beginnen, sobald Ihnen der [Systemadministrator](administrator.md) und der [Datentechniker](data-engineer.md) Zugriff gewährt und Ihre Umgebung vorbereitet haben.
