...
**Auf dieser Seite:** Richten Sie Benutzende, Berechtigungen, Sandboxes und Kanalkonfigurationen ein, damit Ihre Teams sicher und effizient in Adobe Journey Optimizer arbeiten können.
...
* Teilen Sie Entscheidungshandbücher, die Ihr Team bei der Auswahl des richtigen Ansatzes unterstützen: [Journey vs. Kampagnen](../journeys-vs-campaigns.md) und [Journey-Typen: Wählen Sie den richtigen aus](../../building-journeys/journey-types-selection.md)
