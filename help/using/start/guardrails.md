...
* Zusätzlich zu der Zeitüberschreitung, die in Journey-Aktivitäten verwendet wird, gibt es auch eine globale Journey-Zeitüberschreitung, die nicht auf der Benutzeroberfläche angezeigt wird und nicht geändert werden kann. Diese globale Zeitüberschreitung stoppt den Fortschritt von Individuen in der Journey 30 Tage nach ihrem Eintritt. [Weitere Informationen](../building-journeys/journey-gs.md#global_timeout)
...
| Edge Decisioning-API-Anfragen | 1500 pro Sekunde |
