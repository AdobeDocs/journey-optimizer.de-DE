...
Um auf Adobe Journey Optimizer zuzugreifen, melden Sie sich bei [[!DNL Adobe CX Enterprise]](https://experience.adobe.com) mit Ihrer Adobe ID an und klicken Sie dann auf [!DNL Journey Optimizer].
...
1. Klicken Sie auf Ihr Profilsymbol und wählen Sie **[!UICONTROL Voreinstellungen]** aus.
...
![Voreinstellungen für Benachrichtigungen](../rn/assets/do-not-localize/pulse-notif.png){width="60%" align="center"}
...
* [Auswählen Ihres Lernpfads nach Rolle](quick-start.md)
* [Suchen, Filtern und Kategorisieren von Inhalten](search-filter-categorize.md)
...
>title="Aktivität „Linie“"
>abstract="Mit **LINE**-Aktivität können Sie Ihrer orchestrierten Kampagne eine LINE-Aktion hinzufügen. Erstellen Sie personalisierte Inhalte, von Text und Aufklebern bis hin zu Bildern, Videos, Speicherorten und Flex-Nachrichten, um Kundinnen und Kunden über LINE anzusprechen."
