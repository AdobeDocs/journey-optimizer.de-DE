...
* **[!UICONTROL Assets]**: [!DNL Adobe Experience Manager Assets] ist ein zentralisiertes Repository von Assets, die Sie Ihren Nachrichten hinzufügen können. [Weitere Informationen](../content-management/assets.md)
...
* **[!UICONTROL Datenhygiene]** – In diesem Abschnitt können Sie Datenhygiene-Vorgänge konfigurieren und planen, um sicherzustellen, dass Ihre Datensätze ordnungsgemäß gepflegt werden. [Weitere Informationen](../privacy/data-hygiene.md)
...
* **[!UICONTROL Kanäle]** - In diesem Abschnitt können Sie Ihre Kanäle konfigurieren, einschließlich Subdomains, Konfigurationen und Zustellbarkeitseinstellungen. [Weitere Informationen](../configuration/get-started-configuration.md)
