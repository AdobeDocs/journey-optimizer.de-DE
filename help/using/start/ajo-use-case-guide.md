...
title: Welche Journey Optimizer-Funktionen für diesen Auftrag?
...
# Welche Journey Optimizer-Funktionen für diesen Auftrag? {#ajo-use-case-guide}
...
Beginnen Sie mit dem Kanal, den Sie senden möchten: [E-Mail](../email/get-started-email.md) ・ [Push](../push/get-started-push.md) ・ [SMS/MMS/RCS](../mobile/get-started-mobile.md) ・ [Web](../web/get-started-web.md) ・ [In-App](../in-app/get-started-in-app.md). Eine für Mobilgeräte spezifische Anleitung finden Sie im [Mobile Learning Hub](https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/mobile-learning-hub/overview){target="_blank"}.

## Messen und optimieren {#measure-optimize}

Performance verfolgen und verfeinern: [Live-Berichte](../reports/live-report.md) ・ [Überwachen und Analysieren Ihres Journey mit Live-Berichten](https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/tutorials/report-and-monitor/monitor-and-analyze-your-journey-with-live-reports){target="_blank"}. Um Experimente zu analysieren und Empfehlungen für den nächsten Schritt zu erhalten, verwenden Sie [Experimentation Agent](ai-features.md#experimentation-agent) **(AI)** ([Tutorial](https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/tutorials/experimentation/experimentation-agent-overview){target="_blank"}).
