...
| Am besten geeignet für | Nicht empfohlen für |
|----------|---------------------|
...
[Weitere Informationen zur Sendezeitoptimierung](../building-journeys/send-time-optimization.md)
...
## Inhaltsexperiment mit KI {#experimentation}
...
[Weitere Informationen zu HTML von Bildern](../content-management/image-to-html.md)
...
* **[Experimentation Agent](#experimentation-agent)** - Erfordert die Berechtigung „Experimente anzeigen“ und „Experimentmetadaten verwalten“
...
Anzahl Überprüfen Sie [KI-generierte Inhalte](#content-generation) immer auf Genauigkeit und Markenangemessenheit. Verwenden Sie die Feedback-Tools (Daumen hoch/runter), um die Modelle zu verbessern.
