...
**Auf dieser Seite** Wenden Sie die Best Practices von Journey Optimizer für Identitätszuordnung, Omnichannel-Personalisierung und Journey an, damit Sie zuverlässige Anwendungsfälle erstellen und innerhalb der Systembeschränkungen effizient skalieren können.
...
1. Die Marke möchte die Interaktion mit einer Site-Besucherin bzw. einem Site-Besucher 30 Minuten nach Abbruch wiederaufnehmen (z. B. über eine E-Mail zum Warenkorbabbruch):
...
1. Omni-Channel-Interaktion in Web, E-Mail, Push usw.:
...
* Wenn Sie sich Ihrem Grenzwert für Live-Journeys nähern, sollten Sie als Erstes die Registerkarte **Überblick** unter **Journeys** öffnen, um zu sehen, wie viele Journeys mit aktiven Profilen in den letzten 24 Stunden aktiv waren. Dazu können Sie in diesem Abschnitt die Anzahl der Profile überprüfen, die die Journey starten und beenden.
