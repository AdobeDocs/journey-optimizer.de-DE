...
**Auf dieser Seite:** Erfahren Sie, wie Sie GenStudio for Performance Marketing mit Journey Optimizer integrieren können, um E-Mail-Vorlagen zu exportieren, Inhaltsvarianten für Ihre Marke zu generieren und sie zur Verwendung in Ihren E-Mail-Kampagnen zurück zu importieren.
...
* Benutzende müssen mindestens über die Rolle **Mitarbeiter** oder höher verfügen, um die [!DNL GenStudio for Performance Marketing]-Integrationsfunktionen nutzen zu können. [Weitere Informationen zu Benutzerrollen in GenStudio](https://experienceleague.adobe.com/de/docs/genstudio-for-performance-marketing/user-guide/intro/user-roles){target="_blank"}
...
* **KI-gestützte Inhaltserstellung**: Nutzen Sie die generative KI von Adobe, um mehrere markenkonforme E-Mail-Varianten effizient mit intelligenten Textvorschlägen und Design-Elementen zu erstellen.

* **Nahtlose Workflow-Integration**: Exportieren Sie Journey Optimizer-E-Mail-Vorlagen nach GenStudio, erstellen Sie Varianten mit KI-Prompts und importieren Sie sie in einem optimierten Prozess wieder in Journey Optimizer.

* **Zentralisiertes Asset-Management**: Greifen Sie auf den von Adobe Experience Manager Assets unterstützten ContentHub von GenStudio zu, um alle digitalen Assets an einem zentralen Ort zu organisieren, zu speichern und abzurufen.

* **Inhaltsexperimente**: Importieren Sie mehrere E-Mail-Varianten aus GenStudio in Journey Optimizer und nutzen Sie Experimentierfunktionen, um die Inhalte mit der besten Leistung zu testen und zu identifizieren.

* **Leistungsgesteuerte Erkenntnisse**: Verfolgen Sie die Kampagnenleistung mit KI-gestützten Analysen, um zu verstehen, welche kreativen Elemente bei Ihrer Zielgruppe Anklang finden, und optimieren Sie zukünftige Kampagnen.
...
* **Feiertagsangebote und saisonale Promotions**: Erstellen Sie mithilfe von GenStudio-Vorlagen zeitkritische Kampagneninhalte im benötigten Umfang, um die Markenkonsistenz unter Einhaltung enger Fristen sicherzustellen.

* **A/B-Tests im benötigten Umfang**: Erstellen Sie zahlreiche Inhaltsvarianten in GenStudio und testen Sie sie systematisch in Journey Optimizer, um die E-Mail-Leistung kontinuierlich zu verbessern.
...
Der Integrations-Workflow besteht aus zwei Hauptschritten: Exportieren einer Vorlage aus Journey Optimizer nach GenStudio und Importieren von GenStudio-Erlebnissen zurück in Journey Optimizer.

### Exportieren einer HTML-Vorlage von Journey Optimizer nach GenStudio {#export-from-ajo-to-genstudio}

Zunächst können Sie eine [!DNL Journey Optimizer]-HTML-Vorlage mit den Richtlinien Ihrer Marke nach [!DNL GenStudio for Performance Marketing] exportieren. Gehen Sie wie folgt vor.
...
1. Der ausgewählte Inhalt wird im E-Mail-Designer angezeigt.
   ...
   >[!NOTE]
   >
   >[Aus einer  [!DNL Journey Optimizer] -Vorlage](#export-from-ajo-to-genstudio) erstellte GenStudio-Erlebnisse werden direkt in den E-Mail-Designer importiert, in dem alle Bearbeitungsfunktionen zur Verfügung stehen. GenStudio-Erlebnisse, die ohne eine [!DNL Journey Optimizer]-Vorlage erstellt wurden, werden in den [Kompatibilitätsmodus](../email/existing-content.md) importiert, in dem möglicherweise nur eingeschränkte Bearbeitungsfunktionen zur Verfügung stehen.

1. Verwenden Sie die [Tools zur Bearbeitung von E-Mail-Inhalten](../email/content-from-scratch.md) und [Personalisierungsfelder](../personalization/personalize.md), um Ihre E-Mail nach Bedarf zu bearbeiten. Speichern Sie Ihren Inhalt.
...
Hier finden Sie Antworten auf häufig gestellte Fragen zur [!DNL GenStudio for Performance Marketing]-Integration mit [!DNL Journey Optimizer].

+++Kann ich die GenStudio-Integration für andere Kanäle als E-Mail verwenden?

Die [!DNL GenStudio for Performance Marketing]-Integration steht momentan nur für den E-Mail-Kanal zur Verfügung. In zukünftigen Versionen wird möglicherweise Unterstützung für zusätzliche Kanäle hinzugefügt.
+++

+++Ist die GenStudio-Integration für alle Kundinnen und Kunden von Journey Optimizer verfügbar?

Die Integration ist derzeit nicht für die Verwendung mit den Add-ons **Healthcare Shield** oder **Privacy and Security Shield** verfügbar.
+++

+++Kann ich GenStudio-Inhalte bearbeiten, nachdem ich sie in Journey Optimizer importiert habe?

Ja. Nachdem Sie GenStudio-Erlebnisse in [!DNL Journey Optimizer] importiert haben, können Sie die [Tools zur Inhaltsbearbeitung](../email/content-from-scratch.md) des E-Mail-Designers verwenden und Ihren E-Mail-Inhalt mit [Personalisierungsfeldern](../personalization/personalize.md) weiter anpassen.
+++

+++Was passiert mit GenStudio-Erlebnissen, die ohne Journey Optimizer-Vorlage erstellt wurden?

GenStudio-Erlebnisse, die basierend auf einer [!DNL Journey Optimizer]-Vorlage erstellt wurden, werden direkt in den E-Mail-Designer importiert. GenStudio-Erlebnisse, die ohne eine [!DNL Journey Optimizer]-Vorlage erstellt wurden, werden in den [Kompatibilitätsmodus](../email/existing-content.md) importiert.
+++

+++Kann ich mehrere GenStudio-E-Mail-Varianten in Journey Optimizer testen?

Ja. Sie können mehrere Inhaltsabwandlungen erstellen, indem Sie verschiedene GenStudio-E-Mail-Varianten importieren und die Journey Optimizer-Funktion [Inhaltsexperiment](../content-management/content-experiment.md) verwenden, um zu testen, welche Variante bei Ihrer Zielgruppe am besten funktioniert.
+++
