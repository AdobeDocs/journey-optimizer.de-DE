...
➡️ [Weitere Informationen zur Übersicht über Integrationen](integrations.md)
...
➡️ [Erfahren Sie mehr über Administrator- und Marketing-Workflows](integrations.md)
...
➡️ [Weitere Informationen zum Erstellen einer Integration](integrations.md#configure)
...
➡️ [Erfahren Sie mehr über Beispieldaten aus Drittanbietersystemen](integrations.md)
...
➡️ [Weitere Informationen zur Integrationskonfiguration](integrations.md#configure)
...
➡️ [Erfahren Sie mehr über Authentifizierungstypen](integrations.md#configure)
...
➡️ [Erfahren Sie mehr über die Zuordnung von Antwort-Payloads](integrations.md#configure)
...
➡️ [Weitere Informationen zur Personalisierung mit Integrationen](integrations.md#personalization)
...
➡️ [Erfahren Sie mehr über Journey und Kampagnen](integrations.md#limitations)
...
➡️ [Weitere Informationen zu unterstützten Kanälen](integrations.md#limitations)
...
➡️ [Erfahren Sie mehr über Abrufen bzw. Auflisten von APIs](integrations.md#limitations)
...
➡️ [Erfahren Sie mehr darüber, wozu Integrationen dienen](integrations.md)
...
➡️ [Erfahren Sie mehr über das Testen der Verbindung und die Validierung der Payload](integrations.md#configure)
...
➡️ [Weitere Informationen zum Testen der Verbindung und Aktivierung](integrations.md#configure)
