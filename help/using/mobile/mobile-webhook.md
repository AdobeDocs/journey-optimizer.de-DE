...
**Auf dieser Seite:** Erfahren Sie, wie Sie in Adobe Journey Optimizer SMS-Webhooks für eingehendes und Feedback erstellen, um Antworten zum Opt-in und Opt-out-Einverständnis und Versandereignisse für Sinch, Infobip und benutzerdefinierte Anbieter zu erfassen.
...
1. Konfigurieren Sie Ihre Webhook-Einstellungen, wie unten beschrieben:
   ...
   * **[!UICONTROL API-Anmeldedaten]**: Wählen Sie aus der Dropdown-Liste die [zuvor konfigurierten API-Anmeldedaten](mobile-configuration-sinch.md) aus.
...
➡️[Weitere Informationen zur Kanalkonfiguration](mobile-configuration-surface.md)
...
1. Konfigurieren Sie Ihre Webhook-Einstellungen, wie unten beschrieben:
   ...
   * **[!UICONTROL API-Anmeldedaten]**: Wählen Sie aus der Dropdown-Liste die [zuvor konfigurierten API-Anmeldedaten](mobile-configuration-infobip.md#api-credential) aus.
...
1. Konfigurieren Sie Ihre Webhook-Einstellungen, wie unten beschrieben:
   ...
   * **[!UICONTROL API-Anmeldedaten]**: Wählen Sie aus der Dropdown-Liste die [zuvor konfigurierten API-Anmeldedaten](mobile-configuration-custom.md) aus.
...
1. Erstellen Sie eine benutzerdefinierte Payload, die der JSON des Anbieters entspricht. Beachten Sie, dass nur JSON als Webhook-Format unterstützt wird. Formulardaten für Webhooks werden nicht unterstützt.
   ...
   * **InboundNumber**: Die für diese Webhook-Konfiguration verwendete Telefonnummer.
   ...
   >[!TIP]
   >
   > Öffnen Sie das **[!UICONTROL Setup-Handbuch]**, um eine JSON-Payload zu erhalten und eine schrittweise Anleitung zu erhalten.
