...
title: Konfigurieren von Subdomains für Mobile-Nachrichten
...
**Auf dieser Seite:** Erfahren Sie, wie Sie SMS-Subdomains in Adobe Journey Optimizer einrichten, um URLs in Ihren Nachrichten zu kürzen, entweder indem Sie eine bestehende delegierte Subdomain verwenden oder eine neue Subdomain mit einem DNS-Eintrag konfigurieren.
...
Um die URLs zu Ihren SMS-/RCS-/MMS-Nachrichten kürzen zu können, müssen Sie die Subdomain einrichten, die Sie auswählen, wenn Sie [eine SMS-Konfiguration erstellen](mobile-configuration.md#sms-prerequisites).
...
1. Sobald die Prüfungen erfolgreich abgeschlossen wurden, erhält die Subdomain den Status **[!UICONTROL Erfolgreich]**. Sie kann zur Erstellung von Kanälen für SMS-Konfigurationen verwendet werden.
