...
**Auf dieser Seite** Erfahren Sie, wie Sie mehrsprachige Inhalte mit automatisierter Übersetzung erstellen, indem Sie ein Übersetzungsprojekt und Spracheinstellungen einrichten und dann Ihre Kampagnen- oder Journey-Inhalte zur Überprüfung und Veröffentlichung an einen Übersetzungsanbieter senden.
...
1. Beginnen Sie mit der Erstellung von Bedingungen, indem Sie ein Attribut, ein Ereignis oder eine Zielgruppe hinzufügen, um Ihre Zielgruppe zu definieren.
   ...
   1. Greifen Sie auf das Menü **[!UICONTROL Regeln]** zu und erstellen Sie eine neue Regel. Ausführliche Informationen zum Erstellen von Regeln finden Sie in der [!DNL Adobe Experience Platform] [Datenerfassungsdokumentation](https://experienceleague.adobe.com/en/docs/experience-platform/tags/ui/rules){target="_blank"}
