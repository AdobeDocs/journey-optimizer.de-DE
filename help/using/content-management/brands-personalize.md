...
**Auf dieser Seite** Erfahren Sie, wie Sie Ihre Markenrichtlinien personalisieren können, indem Sie Markenidentitäten definieren, Stile schreiben und Regeln für visuelle Inhalte in Adobe Journey Optimizer festlegen.
...
1. Wählen Sie ein Beispiel aus, um es zu aktualisieren, ersetzen Sie das Bild oder klicken Sie auf das Symbol ![ALT-Text](assets/do-not-localize/Smock_Delete_18_N.svg "Löschen"), um es zu löschen.
