...
Adobe Journey Optimizer bietet eine Vielzahl nativer Kanäle, über die Sie effektiv mit Ihrer Zielgruppe interagieren können. Sie können eingehende und ausgehende Nachrichtenversand-Erlebnisse kombinieren.
...
Mit mobilen Apps und Web-Inbound-Erlebnissen initiieren Kundinnen und Kunden Interaktionen. Beispiele sind In-App-Messaging und Web-basierte Erlebnisse, bei denen Benutzende Inhalte zu ihren eigenen Bedingungen bearbeiten. In [!DNL Adobe Journey Optimizer] werden folgende eingehende Kanäle unterstützt:
...
Wählen Sie einen Kanal aus, um tiefer zu gehen und zu erfahren, wie Sie diese Kanäle in Ihrer Marketing-Strategie effektiv nutzen können.
...
* **Kampagnen**: Stellen Sie spezifische Marketing-Kampagnen bereit, die einen bestimmten Kanal verwenden, um zielgerichtete Ziele zu erreichen. Ob Sie ein neues Produkt bewerben oder saisonale Umsätze steigern möchten – mit Kampagnen können Sie zielgerichtete Messaging-Strategien entwickeln, die auf Ihre Zielgruppe zugeschnitten sind. [Erfahren Sie, wie Sie eine Cross-Channel-Kampagne erstellen und ausführen](../campaigns/get-started-with-campaigns.md).
