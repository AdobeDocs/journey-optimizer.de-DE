...
Sehen Sie sich weitere Video-Tutorials zu WhatsApp Messaging und Konfiguration an.

➡️ [WhatsApp-Kanal-Tutorials](https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/tutorials/channels/whatsapp/whatsapp-introduction){target="_blank"}
